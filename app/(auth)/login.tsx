        ...
        <View className="mt-6 pt-4 border-t border-gray-200">
          ...
          <PrimaryButton
            ...
            onPress={async () => {
              setLoading(true);
              try {
                const res = await login('process.env.EXPO_PUBLIC_DEV_FOODSAVER_EMAIL', 'process.env.EXPO_PUBLIC_DEV_FOODSAVER_PASSWORD');
                setUser(res.user);
          ...
          <PrimaryButton
            ...
            onPress={async () => {
              setLoading(true);
              try {
                const res = await login('process.env.EXPO_PUBLIC_DEV_MITRA_EMAIL', 'process.env.EXPO_PUBLIC_DEV_MITRA_PASSWORD');
                setUser(res.user);
