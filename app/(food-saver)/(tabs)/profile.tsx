        ...
        <View className="bg-white rounded-xl overflow-hidden border border-gray-100 mb-4">
          ...
          {editingField === 'name' ? (
            <View className="px-3.5 py-3 border-b border-gray-100">
              <Text className="text-[13px] text-primary font-semibold mb-1.5">Nama</Text>
              <TextInput
              ...
              <View className="flex-row gap-2 mt-2.5">
                <TouchableOpacity onPress={cancelEdit} className="flex-1 bg-gray-100 rounded-lg py-2.5 items-center">
            ...
            >
              ...
              <View className="flex-row items-center gap-1.5">
                <Text className="text-sm font-medium text-gray-900">{user?.name || 'Belum ditambahkan'}</Text>
                <MaterialCommunityIcons name="pencil" size={14} color="#166534" />
              </View>
            </TouchableOpacity>
          )}
          ...
          {editingField === 'phone' ? (
            <View className="px-3.5 py-3">
              <Text className="text-[13px] text-primary font-semibold mb-1.5">Telepon</Text>
              <TextInput
                className="border border-gray-300 rounded-lg px-2.5 py-2 text-sm text-gray-700"
                value={editValue}
                onChangeText={setEditValue}
